...
enum URL {
    ...
    userCreate = '/api/thing/userCreate',
    userUpdate = '/api/thing/userUpdate',
...
const userCreateApi = async (data: any) =>
    post<any>({ url: URL.userCreate, params: {}, data: data, headers: { 'Content-Type': 'multipart/form-data;charset=utf-8' } });
const userUpdateApi = async (data: any) =>
    post<any>({ url: URL.userUpdate, data: data, headers: { 'Content-Type': 'multipart/form-data;charset=utf-8' } });
const deleteApi = async (params: any) => post<any>({ url: URL.delete, params: params, headers: {} });
const detailApi = async (params: any) => get<any>({ url: URL.detail, params: params, headers: {} });

export { listApi, createApi, updateApi, deleteApi, detailApi, listUserThingApi, userCreateApi, userUpdateApi };

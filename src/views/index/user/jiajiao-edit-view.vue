<template>
  <div class="jiajiao-page">
    <div class="page-title">发布新服务</div>
...
import {listUserThingApi, userUpdateApi, userCreateApi} from '/@/api/thing'
...
const submit =()=> {
  ...
  // 始终创建新服务
  userCreateApi(formData).then(res => {
    message.success('发布成功，后台审核中')
    // 跳转到我的服务页面

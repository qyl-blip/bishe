<template>
  <div class="wish-page">
    <div class="page-title">我的心愿单</div>
    <div class="thing-list" v-if="wishData.length">
      <div class="thing-item" v-for="(item,index) in wishData" :key="index">
    ...
    <div v-else class="empty-state">
      <div class="empty-title">暂无心愿</div>
      <div class="empty-subtitle">去首页添加心愿服务吧</div>
    </div>
  </div>
</template>

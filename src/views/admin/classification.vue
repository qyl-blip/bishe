<template>
  <div class="page-surface">
    <div class="page-view page-view--classification">
        ...
        <a-row :gutter="24">
          <a-col span="24">
            <a-form-item label="分类名称" name="title">
              <a-input placeholder="请输入分类名�? v-model:value="modal.form.title"></a-input>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
...
const modal = reactive({
  ...
  rules: {
    title: [{ required: true, message: '请输入分类名�?, trigger: 'change' }],
  },
});
